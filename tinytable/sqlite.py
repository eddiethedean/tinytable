...
from tinytim.rows import iterrows, row_dicts_to_data
...
def data_to_sqlite_table(
    data: MutableMapping, path: str, table_name: str, primary_key: Optional[str] = None, replace_table: bool = False, append_records=False
) -> None:
    """
